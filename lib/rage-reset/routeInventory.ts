...
export const ROUTE_INVENTORY: ExpectedRoute[] = [
  ...
  { path: "/find", expectStatus: 200, group: "directory", requireHeaderFooter: true },
  ...
  { path: "/uk-rage-room-report-2026", expectStatus: 200, group: "editorial", requireHeaderFooter: true },
