...
/**
 * Reusable high-intent CTA pointing at the £1 First Visit Prep Pack.
 */
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            >
              Get the 12-page prep pack covering what happens, what to wear and what to
              check before you go. Your £1 helps maintain the directory.
            </p>
          </div>
        </div>
        <Link
