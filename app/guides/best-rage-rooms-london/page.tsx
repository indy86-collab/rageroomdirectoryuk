...
export const metadata: Metadata = {
  ...
  description: "Discover the best rage rooms in London. Our guide covers top venues in the capital, what to look for, pricing, and local tips for booking your destruction therapy session.",
...
export default async function BestRageRoomsLondonPage() {
  ...
  const content = getGuideCityContent("London")
  const faqs = getCityFAQs("London")

  const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "Best Rage Rooms in London",
    description: "Guide to the best rage rooms and smash rooms in London.",
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <Breadcrumbs
          items={[
            ...
            { label: "Best Rage Rooms in London" },
          ]}
        />
        ...
        <article>
          ...
          {listings.length > 0 ? (
            ...
            <div className="bg-[#181818] rounded-lg border border-zinc-800 p-8 text-center mb-8">
              <p className="text-xl text-white mb-4">No rage rooms listed in London yet.</p>
          ...
          <FAQ items={faqs} title="Frequently Asked Questions About Rage Rooms in London" />

          <div className="mt-10 text-center">
            <Link href="/city/london" className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-semibold px-8 py-3 rounded-md transition-colors">
