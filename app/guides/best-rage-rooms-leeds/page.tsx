...
export const metadata: Metadata = {
  title: "Best Rage Rooms in Leeds | Top Venues Ranked (2025)",
  description: "Discover the best rage rooms in Leeds. Our guide covers top venues in Yorkshire, what to look for, pricing, and local tips for booking your destruction therapy session.",
  openGraph: {
...
export default async function BestRageRoomsLeedsPage() {
  ...
  const content = getGuideCityContent("Leeds")
  const faqs = getCityFAQs("Leeds")

  const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "Best Rage Rooms in Leeds",
    description: "Guide to the best rage rooms and smash rooms in Leeds.",
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <Breadcrumbs
          items={[
            ...
            { label: "Best Rage Rooms in Leeds" },
          ]}
        />

        <article>
          <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-white">
            Best Rage Rooms in Leeds
          </h1>
          ...
          {listings.length > 0 ? (
            ...
            <div className="bg-[#181818] rounded-lg border border-zinc-800 p-8 text-center mb-8">
              <p className="text-xl text-white mb-4">No rage rooms listed in Leeds yet.</p>
          ...
          <FAQ items={faqs} title="Frequently Asked Questions About Rage Rooms in Leeds" />

          <div className="mt-10 text-center">
            <Link href="/city/leeds" className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-semibold px-8 py-3 rounded-md transition-colors">
