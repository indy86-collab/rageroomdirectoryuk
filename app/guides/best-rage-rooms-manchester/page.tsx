...
export const metadata: Metadata = {
  title: "Best Rage Rooms in Manchester | Top Venues Ranked (2025)",
  description: "Discover the best rage rooms in Manchester. Our guide covers top venues in the North West, what to look for, pricing, and local tips for booking your destruction therapy session.",
  alternates: { canonical: "/guides/best-rage-rooms-manchester" },
  openGraph: {
    title: "Best Rage Rooms in Manchester | Top Venues Ranked",
    description: "Find the best rage rooms and smash rooms in Manchester. Compare venues, prices, and book your stress-relief session.",
    type: "article",
  },
}
...
export default async function BestRageRoomsManchesterPage() {
  ...
  const content = getGuideCityContent("Manchester")
  const faqs = getCityFAQs("Manchester")

  const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "Best Rage Rooms in Manchester",
    description: "Guide to the best rage rooms and smash rooms in Manchester.",
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <Breadcrumbs
          items={[
            ...
            { label: "Best Rage Rooms in Manchester" },
          ]}
        />

        <article>
          <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-white">
            Best Rage Rooms in Manchester
          </h1>
          ...
          {listings.length > 0 ? (
            ...
            <div className="bg-[#181818] rounded-lg border border-zinc-800 p-8 text-center mb-8">
              <p className="text-xl text-white mb-4">No rage rooms listed in Manchester yet.</p>
          ...
          <FAQ items={faqs} title="Frequently Asked Questions About Rage Rooms in Manchester" />

          <div className="mt-10 text-center">
            <Link href="/city/manchester" className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-semibold px-8 py-3 rounded-md transition-colors">
