    ...
    <div className="py-6 sm:py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-base sm:text-lg text-zinc-300 mb-6 sm:mb-8 space-y-3 sm:space-y-4">
          ...
          <p>
            Whether you're looking for a unique date night, corporate event, or simply need to let off steam, browse our directory of rage rooms in {cityName} to compare prices, packages, and book your session. Popular with young adults, corporate groups, and anyone seeking an alternative stress-relief activity, rage rooms in {cityName} typically offer 30-minute sessions starting from around £25-30 per person.
          </p>
          <p>
