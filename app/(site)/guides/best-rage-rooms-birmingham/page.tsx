...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Find the best rage rooms and smash rooms in Birmingham. Compare venues, prices, and book your stress-relief session.",
    type: "article",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Best Rage Rooms in Birmingham" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Best Rage Rooms in Birmingham",
    description: "Compare the best rage rooms in Birmingham for 2026.",
    images: [OG_IMAGE],
  },
}
...
export default function BestRageRoomsBirminghamPage() {
  return <CityGuidePage city="Birmingham" path="/guides/best-rage-rooms-birmingham" />
}
